            ...
            <div class="bg-[#05080e]/95 backdrop-blur-xl border border-gray-700/80 rounded-[2rem] p-8 md:p-10 shadow-2xl shadow-black/90 space-y-6">
                ...
                <form action="index.php" method="POST" class="space-y-5">
                    ...
                    <div id="role-panel" class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            >
                                ...
                                <option value="inventario" class="bg-[#131927] text-white">Inventario</option>
                    ...
                    <div class="flex items-center justify-between text-xs text-gray-300">
                        ...
                        <a href="index.php?action=recuperar" class="text-amber-400 hover:text-amber-300">¿Olvidaste tu contraseña?</a>
                    </div>
